...
publishedAt: 2020-06-25T20:00+09:00
---
...
![서비스 사이드이펙트 문제](#/assets/postImages/20200625/side-effect.png)
...
![배포 프로세스](#/assets/postImages/20200625/deploy-strategy.png)
...
![대부분의 유명 오픈소스 프로젝트는 모두 PR Check에서 이 검사를 한다](#/assets/postImages/20200625/pr-build.png)
...
![롤백 프로세스](#/assets/postImages/20200625/rollback-strategy.png)
