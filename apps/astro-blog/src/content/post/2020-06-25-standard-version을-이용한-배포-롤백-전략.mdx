...
<PostImage
  src="#/post/20200625/side-effect.png"
  alt="서비스 사이드이펙트 문제"
/>
...
<PostImage src="#/post/20200625/deploy-strategy.png" alt="배포 프로세스" />
...
<PostImage
  src="#/post/20200625/pr-build.png"
...
<PostImage src="#/post/20200625/rollback-strategy.png" alt="롤백 프로세스" />
