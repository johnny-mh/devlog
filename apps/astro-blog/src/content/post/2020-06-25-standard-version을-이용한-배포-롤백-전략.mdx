...
<Image
  src={import('../../../public/post/20200625/side-effect.png')}
  alt="서비스 사이드이펙트 문제"
  width={736}
  aspectRatio="850:400"
/>
...
<Image
  src={import('../../../public/post/20200625/deploy-strategy.png')}
  alt="배포 프로세스"
  width={736}
  aspectRatio="950:520"
/>
...
<Image
  src={import('../../../public/post/20200625/pr-build.png')}
  alt="대부분의 유명 오픈소스 프로젝트는 모두 PR Check에서 이 검사를 한다"
  width={736}
  aspectRatio="1820:832"
/>
...
<Image
  src={import('../../../public/post/20200625/rollback-strategy.png')}
  alt="롤백 프로세스"
  width={736}
  aspectRatio="960:465"
/>
