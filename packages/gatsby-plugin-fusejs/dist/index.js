...
var require_fuse_common = __commonJS({
  "../../node_modules/fuse.js/dist/fuse.common.js"(exports, module2) {
    ...
    var MISSING_KEY_PROPERTY = function MISSING_KEY_PROPERTY2(name2) {
      return "Missing ".concat(name2, " property in key");
    };
...
var msg = (str) => `[gatsby-plugin-fusejs] ${str}`;
var createPages = async (ctx, opts) => {
  ...
  const index = import_fuse.default.createIndex(keys, data);
  actions.createNode({
...
var createSchemaCustomization = async (ctx) => {
  ...
  createTypes([
    schema.buildObjectType({
      ...
      fields: {
        index: {
          type: "String!",
          description: "The JSON serialized search index string created using the fusejs."
        },
        data: {
          type: "JSON!",
        ...
        publicUrl: {
          ...
          resolve: (node) => {
            ...
            const publicPath = import_path.default.join(
              process.cwd(),
              "public",
              "static",
              filename
